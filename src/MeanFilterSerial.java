...
public class MeanFilterSerial{
    ...
    /**
     * Method to calculate the mean of the specified filter width
    ...
    public static long MeanCalc(int[] blk, int fil){
        ...
        for(int i = 0; i<length; i++){
            ...
            sumR+= (float)((pixel&0x00FF0000)>>16)/length;
            sumG+= (float)((pixel&0x0000FF00)>>8)/length;
            sumB+= (float)((pixel&0x000000FF)>>0)/length;
                ...
                for(int y = x-(w*range); y<x+(w*range); y++){
                    ...
                    if((y-range>=0)&&(y+range<src.length)){
                        ...
                        for(int j = x-range;j<x+range;j++){
                            ...
                            // to ensure no index out of bund errors
                    ...
                    dst[x] = (int)MeanFilterSerial.MeanCalc(block, filter);
